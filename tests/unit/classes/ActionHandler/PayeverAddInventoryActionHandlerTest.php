...
class PayeverAddInventoryActionHandlerTest extends \PHPUnit\Framework\TestCase
{
    ...
    /** @var PayeverAddInventoryActionHandler */
    ...
    public function setUp(): void
    {
        ...
        $this->inventoryTransformer = $this->getMockBuilder(PayeverInventoryTransformer::class)
            ->disableOriginalConstructor()
            ->getMock();
        $this->actionHandler = (new PayeverAddInventoryActionHandler())
